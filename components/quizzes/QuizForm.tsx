...
export default function QuizForm({
  ...
  const [passingMarks, setPassingMarks] = useState(initialData?.passingMarks || 10);
  const [totalMarks, setTotalMarks] = useState(initialData?.totalMarks || 20);
  ...
  return (
    <form onSubmit={handleFormSubmit} className="space-y-8 max-w-4xl mx-auto font-sans">
      ...
      {validationErrors.length > 0 && (
        <div className="rounded-xl border border-rose-250 bg-rose-50 p-5 text-sm text-rose-800 animate-in fade-in slide-in-from-top-4 duration-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              disabled={loading}
              className="w-full rounded-xl border border-slate-250 p-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm bg-slate-50/20"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              disabled={loading}
              className="w-full rounded-xl border border-slate-250 bg-white p-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm"
            >
        ...
        {questions.length === 0 ? (
          ...
          <div className="space-y-6">
            {questions.map((q, qIdx) => (
              <div
                key={qIdx}
                className="bg-white rounded-2xl border border-slate-150 p-6 shadow-xs relative transition-shadow hover:shadow-sm"
              >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      disabled={loading}
                      rows={2}
                      className="w-full rounded-xl border border-slate-250 p-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm bg-slate-50/10"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        disabled={loading}
                        className="w-full rounded-xl border border-slate-250 bg-white p-2.5 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min={1}
                        disabled={loading}
                        className="w-full rounded-xl border border-slate-250 p-2.5 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 text-sm bg-slate-50/10"
                      />
                    </div>
                  </div>
                          ...
                          <div key={optIdx} className="flex items-center gap-2">
                            ...
                            {q.questionType === "SINGLE_CHOICE" ? (
                              <input
                                ...
                                disabled={loading}
                                className="h-4 w-4 border-slate-350 text-indigo-600 focus:ring-indigo-500 cursor-pointer"
                            ...
                            <input
                              ...
                              className={`flex-1 rounded-xl border p-2 shadow-sm focus:outline-none focus:ring-1 text-sm bg-slate-50/5 ${
                                isCorrect
                                  ? "border-emerald-350 bg-emerald-50/10 focus:ring-emerald-500 focus:border-emerald-500"
                                  : "border-slate-250 focus:ring-indigo-500 focus:border-indigo-500"
                              }`}
                            />
